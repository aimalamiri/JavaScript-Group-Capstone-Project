...
class Api {
  ...
  getCategories = () =>
    fetch(`${this.baseUrl}/categories.php`)
  ...
  getByCategory = (category) =>
    fetch(`${this.baseUrl}/filter.php?c=${category}`)
      .then((response) => response.json())
  ...
  getMeal = (idMeal) =>
    fetch(`${this.baseUrl}/lookup.php?i=${idMeal}`)
      .then((response) => response.json())
      .then((json) => json.meals)
  ...
  createApp = async () =>
    fetch(`${this.involvementUrl}/apps/`, {
      method: 'POST',
      body: '',
      headers: {
  ...
  addLike = async (idApp, idMeal) =>
    fetch(`${this.involvementUrl}/apps/${idApp}/likes/`, {
      method: 'POST',
  ...
  getComments = async (idApp, mealId) => {
    ...
    await fetch(`${this.involvementUrl}/apps/${idApp}/comments?item_id=${mealId}`)
      ...
      .catch((error) => {
        throw new Error('No comments found for this meal!');
      });
    return result;
  };
}
